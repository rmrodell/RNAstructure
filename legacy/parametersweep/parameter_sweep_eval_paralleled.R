...
run_limited_combinations <- function() {
  ...
  parameter_combinations <- expand.grid(
    unpaired1_min = 0:3, unpaired1_max = 2:7,
    paired1_min = 0:3, paired1_max = 2:7,
    unpaired2_min = 0:3, unpaired2_max = 2:7,
    paired2_min = c(NA, 0:3), paired2_max = c(NA, 2:7)
  )

  # Filter out invalid combinations (where min > max)
  valid_combinations <- parameter_combinations[
    parameter_combinations$unpaired1_min <= parameter_combinations$unpaired1_max &
    parameter_combinations$paired1_min <= parameter_combinations$paired1_max &
    parameter_combinations$unpaired2_min <= parameter_combinations$unpaired2_max &
    (is.na(parameter_combinations$paired2_min) | 
     parameter_combinations$paired2_min <= parameter_combinations$paired2_max),
  ]
